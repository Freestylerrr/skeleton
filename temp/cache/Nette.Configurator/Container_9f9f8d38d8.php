<?php
// source: E:\+++Software+++\wamp\www\skeleton\app/config/config.neon 
// source: E:\+++Software+++\wamp\www\skeleton\app/config/config.local.neon 

class Container_9f9f8d38d8 extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'Nette\Database\IConventions' => array(
				1 => array('database.default.reflection'),
			),
			'Nette\Database\Conventions\StaticConventions' => array(
				1 => array('database.default.reflection'),
			),
			...
			'App\Model\Base' => array(1 => array('25_App_Model_Articles')),
			'App\Model\Articles' => array(1 => array('25_App_Model_Articles')),
			...
			'AdminModule\BasePresenter' => array(
				array(
					'application.1',
					'application.2',
					'application.3',
			...
			'AdminModule\ArticlesPresenter' => array(array('application.1')),
			'AdminModule\HomepagePresenter' => array(array('application.2')),
			'AdminModule\MenuPresenter' => array(array('application.3')),
			'AdminModule\SignPresenter' => array(array('application.4')),
			'AdminModule\UsersPresenter' => array(array('application.5')),
			'FrontModule\BasePresenter' => array(array('application.6')),
			'FrontModule\HomepagePresenter' => array(array('application.6')),
		...
		'services' => array(
			'25_App_Model_Articles' => 'App\Model\Articles',
			'26_App_Model_UserManager' => 'App\Model\UserManager',
			'application.1' => 'AdminModule\ArticlesPresenter',
			'application.2' => 'AdminModule\HomepagePresenter',
			'application.3' => 'AdminModule\MenuPresenter',
			'application.4' => 'AdminModule\SignPresenter',
			'application.5' => 'AdminModule\UsersPresenter',
			'application.6' => 'FrontModule\HomepagePresenter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'E:\+++Software+++\wamp\www\skeleton\app',
			'wwwDir' => 'E:\+++Software+++\wamp\www\skeleton\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'E:\+++Software+++\wamp\www\skeleton\app/../temp',
		));
	}
	 ...
	 */
	public function createService__25_App_Model_Articles()
	{
		$service = new App\Model\Articles($this->getService('database.default.context'));
		return $service;
	}
	...
	/**
	 * @return AdminModule\ArticlesPresenter
	 */
	public function createServiceApplication__1()
	{
		$service = new AdminModule\ArticlesPresenter;
		...
		$service->articles = $this->getService('25_App_Model_Articles');
	...
	{
		$service = new AdminModule\HomepagePresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->articles = $this->getService('25_App_Model_Articles');
	...
	/**
	 * @return AdminModule\MenuPresenter
	 */
	public function createServiceApplication__3()
	{
		$service = new AdminModule\MenuPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->articles = $this->getService('25_App_Model_Articles');
	...
	{
		$service = new AdminModule\SignPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->articles = $this->getService('25_App_Model_Articles');
	...
	{
		$service = new AdminModule\UsersPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->articles = $this->getService('25_App_Model_Articles');
	...
	{
		$service = new FrontModule\HomepagePresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->invalidLinkMode = 5;
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'E:\+++Software+++\wamp\www\skeleton\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('E:\+++Software+++\wamp\www\skeleton\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('E:\+++Software+++\wamp\www\skeleton\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=sud', 'root', NULL, array('lazy' => TRUE));
	...
	public function createServiceDatabase__default__context()
	{
		$service = new Nette\Database\Context($this->getService('database.default.connection'), $this->getService('database.default.structure'),
			$this->getService('database.default.reflection'), $this->getService('cache.storage'));
		return $service;
	}
	 ...
	 */
	public function createServiceDatabase__default__reflection()
	{
	...
	{
		return new Container_9f9f8d38d8_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('E:\+++Software+++\wamp\www\skeleton\app/../temp/cache/latte');
...
final class Container_9f9f8d38d8_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{

	private $container;


	public function __construct(Container_9f9f8d38d8 $container)
	{
