<?php
// source: D:\+++Software+++\wamp\www\skeleton\app/config/config.neon 
// source: D:\+++Software+++\wamp\www\skeleton\app/config/config.local.neon 

class Container_23f6c91ac8 extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'D:\+++Software+++\wamp\www\skeleton\app',
			'wwwDir' => 'D:\+++Software+++\wamp\www\skeleton\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'D:\+++Software+++\wamp\www\skeleton\app/../temp',
		));
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'D:\+++Software+++\wamp\www\skeleton\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('D:\+++Software+++\wamp\www\skeleton\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('D:\+++Software+++\wamp\www\skeleton\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_23f6c91ac8_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('D:\+++Software+++\wamp\www\skeleton\app/../temp/cache/latte');
...
final class Container_23f6c91ac8_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{

	private $container;


	public function __construct(Container_23f6c91ac8 $container)
	{
