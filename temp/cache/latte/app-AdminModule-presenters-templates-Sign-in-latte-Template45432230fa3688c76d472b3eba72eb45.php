<?php
// source: E:\+++Software+++\wamp\www\skeleton\app\AdminModule\presenters/templates/Sign/in.latte

class Template45432230fa3688c76d472b3eba72eb45 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('e51e20fefe', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block signIn
//
if (!function_exists($_b->blocks['signIn'][] = '_lb28c25cf3f9_signIn')) { function _lb28c25cf3f9_signIn($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
