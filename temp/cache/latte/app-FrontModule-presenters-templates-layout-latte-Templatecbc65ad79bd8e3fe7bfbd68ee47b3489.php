<?php
// source: E:\+++Software+++\wamp\www\skeleton\app\FrontModule\presenters/templates/@layout.latte

class Templatecbc65ad79bd8e3fe7bfbd68ee47b3489 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('05017ebbd8', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbd1503c743c_head')) { function _lbd1503c743c_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb1ac68524d7_scripts')) { function _lb1ac68524d7_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
