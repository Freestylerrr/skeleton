<?php
// source: D:\+++Software+++\wamp\www\skeleton\app\AdminModule\presenters/templates/@layout.latte

class Template0a02122345ceeb3b2f8b22cdd75af36f extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('7856613f68', 'html')
;
