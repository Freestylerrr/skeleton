<?php
// source: E:\+++Software+++\wamp\www\skeleton\app\FrontModule\presenters/templates/Homepage/default.latte

class Templateb6e606dc3ed4a7916ebaec380a587109 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('e1eecf5cbb', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb451380cbce_content')) { function _lb451380cbce_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbc377040dd8_title')) { function _lbc377040dd8_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb593c5dc777_scripts')) { function _lb593c5dc777_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb4149d65590_head')) { function _lb4149d65590_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
