<?php
// source: D:\+++Software+++\wamp\www\skeleton\app\AdminModule\presenters/templates/Users/default.latte

class Template7bafef3cf2dc281b523eda3da7881980 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('27ac847cfc', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb3dce42aaec_content')) { function _lb3dce42aaec_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
